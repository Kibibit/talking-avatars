...
/* harmony export */   playAudioWav: () => (/* binding */ playAudioWav)
/* harmony export */ });
// IMOPORTED!
let playSound = true;
...
function playAudio(text, shorten = false, pitch = 0.7) {
  if (!playSound) { return; }
  var audio = new Audio();
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _sound_engine__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./sound-engine */ "./src/sound-engine.js");
...
function start() {
  ...
  function laughAnimation(onComplete) {
    (0,_sound_engine__WEBPACK_IMPORTED_MODULE_0__.playAudio)("ha.ha.ha");
    blinkTimeline.pause(0);
    $("#Eyes\\/Happy-😁").show();
    $("#Eyes\\/Default-😀").hide();
  ...
  function displayRandomText() {
    ...
    (0,_sound_engine__WEBPACK_IMPORTED_MODULE_0__.playAudio)(currentQuote.quoteToSay || currentQuote.quote, false, currentQuote.pitch);
  ...
  function wizardAnimation(onComplete) {
    (0,_sound_engine__WEBPACK_IMPORTED_MODULE_0__.playAudioWav)("https://noproblo.dayjo.org/ZeldaSounds/LOZ/LOZ_Fanfare.wav");
    onComplete && onComplete();
  }
